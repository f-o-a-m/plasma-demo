...
type ConstructorFn = Tagged (SProxy "constructor(uint256,uint256,uint256,uint256)") (Tuple4 (Tagged (SProxy "_exitDelay") (UIntN (D2 :& D5 :& DOne D6))) (Tagged (SProxy "_depositChallengePeriod") (UIntN (D2 :& D5 :& DOne D6))) (Tagged (SProxy "_nonDepositChallengePeriod") (UIntN (D2 :& D5 :& DOne D6))) (Tagged (SProxy "_minExitBond") (UIntN (D2 :& D5 :& DOne D6))))

constructor :: TransactionOptions NoPay -> HexString -> { _exitDelay :: (UIntN (D2 :& D5 :& DOne D6)), _depositChallengePeriod :: (UIntN (D2 :& D5 :& DOne D6)), _nonDepositChallengePeriod :: (UIntN (D2 :& D5 :& DOne D6)), _minExitBond :: (UIntN (D2 :& D5 :& DOne D6)) } -> Web3 HexString
constructor x0 bc r = uncurryFields  r $ constructor' x0 bc
   where
    constructor' :: TransactionOptions NoPay -> HexString -> (Tagged (SProxy "_exitDelay") (UIntN (D2 :& D5 :& DOne D6))) -> (Tagged (SProxy "_depositChallengePeriod") (UIntN (D2 :& D5 :& DOne D6))) -> (Tagged (SProxy "_nonDepositChallengePeriod") (UIntN (D2 :& D5 :& DOne D6))) -> (Tagged (SProxy "_minExitBond") (UIntN (D2 :& D5 :& DOne D6))) -> Web3 HexString
...
--------------------------------------------------------------------------------
-- | DepositChallengePeriodFn
--------------------------------------------------------------------------------


type DepositChallengePeriodFn = Tagged (SProxy "depositChallengePeriod()") (Tuple0 )

depositChallengePeriod :: TransactionOptions NoPay -> ChainCursor -> Web3 (Either CallError (UIntN (D2 :& D5 :& DOne D6)))
depositChallengePeriod x0 cm = map unTuple1 <$> call x0 cm ((tagged $ Tuple0 ) :: DepositChallengePeriodFn)
...
type ExitDelayFn = Tagged (SProxy "exitDelay()") (Tuple0 )

exitDelay :: TransactionOptions NoPay -> ChainCursor -> Web3 (Either CallError (UIntN (D2 :& D5 :& DOne D6)))
exitDelay x0 cm = map unTuple1 <$> call x0 cm ((tagged $ Tuple0 ) :: ExitDelayFn)
...
--------------------------------------------------------------------------------
-- | NonDepositChallengePeriodFn
--------------------------------------------------------------------------------


type NonDepositChallengePeriodFn = Tagged (SProxy "nonDepositChallengePeriod()") (Tuple0 )

nonDepositChallengePeriod :: TransactionOptions NoPay -> ChainCursor -> Web3 (Either CallError (UIntN (D2 :& D5 :& DOne D6)))
nonDepositChallengePeriod x0 cm = map unTuple1 <$> call x0 cm ((tagged $ Tuple0 ) :: NonDepositChallengePeriodFn)
