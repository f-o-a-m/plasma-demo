...
module Plasma.Contracts.ExtendedERC20 where
...
import Network.Ethereum.Web3.Solidity (ByteString, D2, D5, D6, DOne, Tuple0(..), Tuple1(..), Tuple2(..), Tuple3(..), UIntN, class IndexedEvent, unTuple1)
